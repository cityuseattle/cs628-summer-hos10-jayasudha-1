...
const FACEBOOK_APP_ID = '339037611882286';
const FACEBOOK_APP_SECRET = 'a1054d2b6c3f02ba24128bd2ef794e54';
  ...
  new FacebookStrategy(
    {
      ...
      // Your callback URL
      callbackURL: 'https://miniature-guacamole-v6v666gggjxvhp5xp-5050.app.github.dev/facebook/callback', 
...
app.get('/facebook/callback', passport.authenticate('facebook', {
  ...
  successRedirect: 'https://miniature-guacamole-v6v666gggjxvhp5xp-3000.app.github.dev/home', 
  // Redirect to login page on authentication failure.
  failureRedirect: 'https://miniature-guacamole-v6v666gggjxvhp5xp-3000.app.github.dev/', 
}));
